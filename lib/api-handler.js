...
const handleApi = async (req, res, urlPath) => {
  ...
  try {
    ...
    if (resource === "dashboard") {
      ...
      const month = visitsLib.summarizeMonth(visitRows, subs);
      return json(res, 200, {
        news: news.length,
        ...
        visitsTotal: month.totalVisits,
        uniqueIps: month.uniqueIps,
        suspiciousIps: month.suspicious,
        visitSeries: month.series,
        visitLabels: month.labels,
        visitMonthLabel: month.monthLabel,
        visitors: month.visitors.slice(0, 200),
      });
    }
    ...
    if (resource === "visits") {
      ...
      return json(res, 200, {
        ...
        visitLabels: month.labels,
        visitMonthLabel: month.monthLabel,
        visitors: month.visitors.slice(0, 300),
      });
    }
